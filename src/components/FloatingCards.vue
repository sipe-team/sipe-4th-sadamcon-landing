...
const cards: Card[] = [
  ...
  },
  {
    ...
    content: "주문·결제 시스템의 중복처리와 데이터 정합성 문제를 Redis Lettuce 기반 분산 락으로 해결한 실무 사례를 소개합니다. Redis 락 구현 방법부터 실제 운영 사례, 한계점과 개선 방안까지 폭넓게 다룹니다.",
    speakerName: "장준환",
...
JVM 생태계와 데이터 엔지니어링에 큰 매력을 느끼고 있습니다.`,
  ...
  },
  {
    ...
    content: "MAU 20만 이상의 LLM 서비스 운영 경험을 통해 본 LLMOps의 이상과 현실을 공유합니다. 기술적 구현보다는 실무에서 마주한 예상치 못한 문제들과 해결 과정을 전달하며, 빠르게 발전하는 AI 기술 앞에서 느끼는 현실적 고민까지 다룹니다.",
    speakerName: "김민준",
